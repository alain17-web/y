...
const Sidebar = () => {
    ...
    return (
            ...
            <div className="flex flex-col mt-12 w-[20%] h-[100vh] gap-10  border-r border-gray-200 fixed top-28 left-0">
                ...
                <NavLink to={"/dashboard"} className={`flex items-center ml-16 ${location.pathname === '/dashboard' ? 'font-bold' : ''}`} activeClassName="font-bold">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor"
                         className="bi bi-house-door-fill mr-10" viewBox="0 0 16 16">
                        <path
                            d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5"/>
                    </svg>
                    <p className="text-3xl font-inter">Home</p>
                </NavLink>
                <NavLink to={"#"} className={`flex items-center ml-16 ${location.pathname === '#' ? 'font-bold' : ''}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor"
                ...
                <NavLink to={"/profile"} className={`flex items-center ml-16 ${location.pathname === '/profile' ? 'font-bold' : ''}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor"
